...
> This code is an impelentation of linear algorithm of perceptrin with offset

![algorithm](images/readme/perceptron.png)
...
* 0.0.1
    * first version - implement perceptron algorithm with offset
